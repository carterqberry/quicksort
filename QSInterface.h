...
public:
	...
	1) Calculates the middle index by averaging the given left and right indices:
	   middle = (left + right)/2
	2) Then bubble-sorts the values at the left, middle,Calculates the median index, and then sorts the first, middle, and last
		numbers in the array based on their data-value and right indices.
